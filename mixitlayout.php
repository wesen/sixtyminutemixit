...
<tr class="mast"><td>
<div class="mLogo"><a href="index.php"><strong>#em411@irc.esper.net</strong><br><span class="small">sixtyminutemixit impromptu competition</span></a></div>
</td></tr>

<tr><td style="padding-top:0;"><div id="menu">
...
?>
   ...
   <tr><td id="mainPageContent">

   <div style=padding:0;margin-bottom:10px;></div>
						
   <table width="100%" cellpadding="0" cellspacing="0" border="0">
     <tr><td class="sideColumn" style="width:25%;"><?php mixitList(); ?></td>
