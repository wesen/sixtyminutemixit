    ...
    if (doesMixitExist($current_mixit) && !isMixitFinished($current_mixit)) {
        ...
        <form action="create-mixit.php" method="POST">
            <table>
                ...
                <tr>
                    <td>Duration (min.):</td>
                    <td><input type="text" value="60" name="duration" size="20"/></td>
                </tr>
                <tr>
                    <td>Description:</td>
                ...
                <tr>
                    <td cols="2"><input type="submit" value="Mixit!"></td>
                </tr>
            </table>
        </form>
        <?php
    ...
    if (($current_mixit == $mixit) && doesMixitExist($current_mixit) && !isMixitStarted($current_mixit)) {
        ...
        <form action="create-mixit.php" method="POST">
            <table>
                ...
                <tr>
                    <td>Current Mixit:</td>
                    <td><?php echo "Mixit " . $current_mixit . ": " . mixitDescription($current_mixit) ?></td>
                </tr>
                <tr>
                    <td cols="2"><input type="submit" value="Start!"></td>
                </tr>
            </table>
        </form>
    ...
    if (doesMixitExist($mixit)) {
        ...
        <form action="create-mixit.php" method="POST">
            <table>
                ...
                <tr>
                    <td>Old duration was <?php echo mixitDuration($mixit) ?> minutes, new duration (in minutes):</td>
                    <td><input type="text" name="duration" size="20" value="<?php echo mixitDuration($mixit); ?>"/></td>
                </tr>
                <?php if (!loggedIn()) { ?>
                    <tr>
                        <td>Login:</td>
                ...
                <?php } ?>
                <tr>
                    <td cols="2"><input type="submit" value="Change duration!"></td>
                </tr>
            </table>
        </form>
        ...
        if (isMixitSampleUploadAllowed($mixit)) {
            ...
            <form action="create-mixit.php" method="POST">
                <table>
                    ...
                    <?php } ?>
                    <tr>
                        <td cols="2"><input type="submit" value="Stop sample upload!"></td>
                    </tr>
                </table>
            </form>
            ...
            <form action="create-mixit.php" method="POST">
                <table>
                    ...
                    <?php } ?>
                    <tr>
                        <td cols="2"><input type="submit" value="Allow sample upload!"></td>
                    </tr>
                </table>
            </form>
    ...
    if (doesMixitExist($mixit) && isMixitFinished($mixit)) {
        ...
        <form action="create-mixit.php" method="POST">
            <table>
                ...
                <?php } ?>
                <tr>
                    <td cols="2"><input type="submit" value="Finalize!"></td>
                </tr>
            </table>
        </form>
